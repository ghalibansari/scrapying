...
var agentFirstPage = 4077 // 1
var agentLastPage = 4100  // 5587
...
func fetchPage(pageNumber int, page playwright.Page, jsonData *Agents) error {
...
func handleCard(card playwright.Locator, jsonData *Agents, wg *sync.WaitGroup, mu *sync.RWMutex, idx int, pageNumber int) {
	...
	id := shared.GenerateMD5Hash(name + companyName + contactNumber)
